...
enum OperandCode{
  TNEURALNETWORKS_FLOAT32 = 0,
  TNEURALNETWORKS_INT32 = 1,
  TNEURALNETWORKS_UINT32 = 2,
  TNEURALNETWORKS_TENSOR_FLOAT32 = 3,
  TNEURALNETWORKS_TENSOR_INT32 = 4,
  TNEURALNETWORKS_TENSOR_QUANT8_ASYMM = 5
}
